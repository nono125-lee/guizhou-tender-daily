...
- 施工板块例外：只允许在资格要求、资质要求、特殊资格要求栏目匹配
  ...
  审计、招标代理时直接排除。
- 电力施工收录词包含“电力工程施工总承包”和“承装（修、试）”；地灾施工收录词包含“地质灾害防治单位”，仍只能在资格类栏目命中。
...
- 贵州省公共资源交易云采用列表层标题命中优先队列：标题命中项不受普通正文详情探索配额截断；各栏目保持独立公告ID状态、游标和详情重试；每次扫描输出 `scan_complete` 和 warnings。
