...
页面标题为“标讯雷达”，包含“今日待看、施工粗筛、招标计划、重点关联、运行状态”五个栏目。施工粗筛保留地区、时间、信息源、报名日期、截止日期和资质要求筛选；招标计划展示全部计划，并保留地州市、区县、发布时间、预计招标月及资金来源快捷筛选。原施工详细页和招标计划详细页继续保留，作为字段复核和历史版本入口。
